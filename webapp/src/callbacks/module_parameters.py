...
def get_callbacks(app):
    ...
    def callback_set_num_or_json_parameters(values, ids, current_pipelines):
        return set_num_or_json_parameters(values, ids, current_pipelines)
    ...
    def callback_set_string_parameters(values, ids, current_pipelines):
        return set_string_parameters(values, ids, current_pipelines)
    ...
    def callback_check_text_input(user_input, component):
        return check_text_input(user_input, component)
